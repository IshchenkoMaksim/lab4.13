...
class View(QMainWindow):
    ...
    def __init__(self):
        ...
        self.controller = EditorController(
            EditorModel(), self.x1, self.y1, self.x2, self.y2, self.scene
        )
